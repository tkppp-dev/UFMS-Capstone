...
public class BuildingController {
    ...
    @Transactional
    public ResponseEntity<?> save(@RequestBody BuildingDto.RequestBuilding building){
    ...
    @Transactional
    public ResponseEntity<?> update(@PathVariable Long id,@RequestBody BuildingDto.RequestBuilding building){
    ...
    @Transactional
    public  ResponseEntity<?> delete(@RequestBody BuildingDto.BuildingDeleteId deleteId) {
